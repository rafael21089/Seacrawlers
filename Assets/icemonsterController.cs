...
public class icemonsterController : MonoBehaviour
{
    ...
    private HealthSystemForDummies icemonsterHealth;
    public Collider col;
    ...
    void Start()
    {
        ...
        icemonsterHealth = GetComponent<HealthSystemForDummies>();
    ...
    void Update()
    {
        ...
        {
            if (icemonsterHealth.CurrentHealth <= 0 && onetime == false)
            {
                animator.SetTrigger("dead");
                this.gameObject.tag = "Untagged";
                objectiveManager.KillFrostBoss();
                onetime = true;
            ...
            else
            {
                if (distance <= skillRadius)
                {
                    ...
                    if (!animator.GetCurrentAnimatorStateInfo(0).IsName("IceSkill"))
                    {
                ...
                if (distance <= chaseRadius && distance > shootRadius && !animator.GetCurrentAnimatorStateInfo(0).IsName("IceSkill"))
                {
