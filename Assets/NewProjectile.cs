    ...
    private void Explode()
    {
        ...
        for (int i = 0; i < objectsInRange.Length; i++)
        {
            ...
            else
            {
                ...
                /*if (objectsInRange[i].GetComponent<Destructable>() != null)
                {
                    //destroy objects close
                    Destructable dest = objectsInRange[i].GetComponent<Destructable>();
                    dest.DestroyObj();
                    //destroy objects close
                    ////Destructable dest = GetComponent<Destructable>();
                    ////Debug.Log("DESSSTTT" + dest);
                    ////if (dest != null)
                    ////{
                    ////
                    ////    dest.DestroyObj();
